...
def test_no_field_impl(field_name):
    with pytest.raises(TypeError) as excinfo:
        ...
        test_request_class = pycats_dataclass(type("_RequestModel", (BaseRequestModel,),
...
def test_missing_decorator_exception():
    with pytest.raises(MissingDecoratorError) as excinfo:
        ...
        test_request_class()
    assert "Child dataclass _RequestModel should have @pycats_dataclass decorator" in str(excinfo.value)
